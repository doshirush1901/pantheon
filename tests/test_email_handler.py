...
class TestEmailData:
    ...
    def test_initialization(self):
        ...
        email = EmailData(
            ...
            from_name="John Doe",
        to_email="ira@example-company.org",
...
class TestEmailHandler:
    ...
    def test_is_internal_machinecraft_in(self, mock_handler):
        ...
        assert mock_handler.is_internal("founder@example-company.in") is True
    ...
    def test_process_email_skips_internal(self, mock_handler):
        ...
        email = EmailData(
            message_id="msg_123",
            thread_id="thread_456",
            from_email="founder@example-company.in",
            from_name="Founder",
            to_email="ira@example-company.org",
...
On Feb 27, 2026, at 10:00 AM, Ira <ira@example-company.org> wrote:
