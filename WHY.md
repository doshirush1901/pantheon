...
6. LEARNS     → Boss says "Actually, Batelaan shut down last year,
...
CUSTOMER: "What machine do you recommend for 4mm thick ABS sheets,
           1500x1000mm forming area?"
                   ...
                   "Okay, this is a recommendation query
                    involving material thickness and size.
                    I need research first."
                            |
                            v
                    
                   CLIO (The Researcher)
                   *searches Qdrant, Mem0, machine database*
                   "Found 3 matching machines. PF1-C-2015 is
                    the best fit. AM series is ruled out —
                    only handles ≤1.5mm."
                            |
                            v
                    
                   CALLIOPE (The Writer)
                   "Here's a draft response in the company's
                    brand voice, with specs formatted as a
                    table, warm greeting, clear CTA."
                            |
                            v
                    
                   VERA (The Fact Checker)
                   *checks every claim against the database*
                   "Draft looks good. Added AM series warning.
                    Added pricing disclaimer. Verified forming
                    area specs. 3 claims verified, 0 corrected."
                            |
                            v
                   ...
                   *quietly, in the background*
                   "Good interaction. Thickness guidance was
                    correct. Logging this as a successful
                    recommendation pattern."
```

And if the boss replies "Actually, the PF1-C-2015 price went up last month" — the feedback handler stores that correction *immediately* in long-term memory. The next person who asks gets the right price. No retraining. No redeployment. It just... learns.
...
products:
  ...
  rules_file: "data/brain/hard_rules.txt"  # "AM series is ALWAYS ≤1.5mm"
```
...
## Part 7: The Part Where I Ask You to Star the Repo
...
*Built by [Rushabh Doshi](https://github.com/doshirush1901) at [Machinecraft Technologies](https://machinecraft.org). Written in Python. Powered by stubbornness.*
