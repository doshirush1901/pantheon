...
# =============================================================================
# EXTRACTED MODULES (Phase 3 remediation)
# =============================================================================
# Personality, response types, and ContextPack are now in their own modules.
# Imported here for backward compatibility with all existing callers.

from response_types import (  # noqa: E402
    ResponseMode, ConfidenceLevel, Citation, ResponseObject, ContextPack,
)
from personality import (  # noqa: E402
    IRA_OPENERS, IRA_CLOSERS, IRA_DRY_HUMOR, EMOTIONAL_OPENERS,
)



# Citation, ResponseObject, ContextPack now imported from response_types.py
