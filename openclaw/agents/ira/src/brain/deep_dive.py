...
_SESSIONS_DIR = Path(__file__).parent.parent.parent.parent / "workspace" / "deep_dive_sessions"
...
def get_session(chat_id: str) -> Optional[DeepDiveSession]:
    ...
    try:
        ...
        logger.warning(f"Failed to load session for {chat_id}: {e}")
        return None
...
# ============================================================================
# JSON EXTRACTION (robust LLM output parsing)
# ============================================================================

def _extract_json_array(text: str) -> Optional[list]:
    """Extract a JSON array from LLM output, handling fences and trailing text."""
    text = text.strip()
