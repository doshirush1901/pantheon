...
# Brain State Classes (extracted to src/core/)
from ..core.brain_state import BrainState, ProcessingPhase, AttentionManager, FeedbackLearner
...
__all__ = [
    ...
    "get_unified_memory",
    # Brain State Classes (from src/core/)
    "BrainState",
    "ProcessingPhase",
    "AttentionManager",
    "FeedbackLearner",
